...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "infec2ouscoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"infec2ouscoin.com", "seed.infec2ouscoin.com"},
//    {"infec2ouscoinpool.org", "dnsseed.infec2ouscoinpool.org"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. infec2ouscoin is probably already running."), addrBind.ToString().c_str());
        else
